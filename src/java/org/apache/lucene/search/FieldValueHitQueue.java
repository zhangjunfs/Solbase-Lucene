...
public abstract class FieldValueHitQueue extends PriorityQueue {
  ...
  final static class Entry {
    ...
    Entry(int slot, int docID, float score, int[] sorts) {
      this.slot = slot;
      this.docID = docID;
      this.score = score;
    ...
    public String toString() {
      return "slot:" + slot + " docID:" + docID + " score=" + score + " sorts=" + sorts;
    }
  }
  ...
  FieldDoc fillFields(final Entry entry) {
    ...
    return new FieldDoc(entry.docID, entry.score, fields, entry.sorts);
  }
